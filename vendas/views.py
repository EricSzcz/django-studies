...
class DashboardView(View):
    ...
    def get(self, request):
        ...
        data['n_ped_nfe'] = Venda.objects.num_ped_nfe()
...
class NovoItemPedido(View):
    ...
    def post(self, request, venda):
        ...
        if item:
            data['mensagem'] = 'item já incluido no pedido, por favor editar o pedido'
            item = item[0]
...
class ListaVendas(View):
    def get(self, request):
        try:
            ...
            #logger.error(str(e))
        logger.debug('accessaram a listagem de vendas')
...
class ExcluiItemPedido(View):
    def get(self, request, item):
        ...
        return render(request, 'vendas/exclui-item-pedido.html', {'item_pedido': item_pedido})
...
class ExcluirPedido(View):
    def get(self, request, venda):
        return render(request, 'vendas/excluir-pedido.html', {'venda': venda})
